...
that the available documents do not provide enough evidence. 
Make sure to verify dates and Quarter of response matches the user's query.
Do not fill gaps from general
